...
export const DEVICES: Device[] = [
  ...
  { id: 'apple-m3-max-14c', name: 'Apple M3 Max (14-core)', category: 'apple', bandwidthGBps: 300 }, // prettier-ignore
  ...
  { id: 'apple-m4-max-14c', name: 'Apple M4 Max (14-core)', category: 'apple', bandwidthGBps: 410 }, // prettier-ignore
  ...
  { id: 'rtx-3090-ti', name: 'Nvidia RTX 3090 Ti', category: 'nvidia', bandwidthGBps: 1008, memoryGB: 24 }, // prettier-ignore
  // RTX 40 series
  ...
  { id: 'rtx-4070-ti-super', name: 'Nvidia RTX 4070 Ti Super', category: 'nvidia', bandwidthGBps: 672, memoryGB: 16 }, // prettier-ignore
  { id: 'rtx-4080', name: 'Nvidia RTX 4080', category: 'nvidia', bandwidthGBps: 717, memoryGB: 16 },
  { id: 'rtx-4080-super', name: 'Nvidia RTX 4080 Super', category: 'nvidia', bandwidthGBps: 736, memoryGB: 16 }, // prettier-ignore
  { id: 'rtx-4090', name: 'Nvidia RTX 4090', category: 'nvidia', bandwidthGBps: 1008, memoryGB: 24 },
  // RTX 50 series
  { id: 'rtx-5070-ti', name: 'Nvidia RTX 5070 Ti', category: 'nvidia', bandwidthGBps: 896, memoryGB: 16 }, // prettier-ignore
  ...
  // Workstation
  { id: 'rtx-a6000', name: 'Nvidia RTX A6000', category: 'nvidia', bandwidthGBps: 768, memoryGB: 48 },
  { id: 'rtx-6000-ada', name: 'Nvidia RTX 6000 Ada', category: 'nvidia', bandwidthGBps: 960, memoryGB: 48 }, // prettier-ignore
  // Datacenter
  { id: 'a100-80gb', name: 'Nvidia A100 80GB', category: 'nvidia', bandwidthGBps: 1935, memoryGB: 80 }, // prettier-ignore
  { id: 'h100-pcie', name: 'Nvidia H100 PCIe', category: 'nvidia', bandwidthGBps: 2000, memoryGB: 80 }, // prettier-ignore
  { id: 'h100-sxm', name: 'Nvidia H100 SXM', category: 'nvidia', bandwidthGBps: 3350, memoryGB: 80 },
  { id: 'h200-sxm', name: 'Nvidia H200 SXM', category: 'nvidia', bandwidthGBps: 4800, memoryGB: 141 }, // prettier-ignore
